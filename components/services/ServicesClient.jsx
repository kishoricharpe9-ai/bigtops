  ...
  return (
    <section className="pb-24">
      ...
      <Container className="relative z-15 -mt-[15vh] sm:-mt-[10vh] max-w-6xl">
        ...
        <Reveal>
          <div className="flex flex-row overflow-x-auto md:flex-wrap justify-start md:justify-center items-center gap-3 py-2 w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] scroll-smooth">
            {services.map((s) => {
