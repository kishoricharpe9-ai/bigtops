        ...
        <Container className="relative">
          ...
          <Reveal delay={0.1} className="mt-24 mx-auto w-full max-w-7xl">
            ...
            <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-14">
              ...
              <div className="flex flex-col gap-6 lg:col-span-6 lg:order-1">
                {/* Vision */}
                <div className="group relative overflow-hidden rounded-[24px] bg-white/[0.02] border border-white/20 p-8 sm:p-10 transition-colors hover:border-[#12ced6]/50 hover:bg-white/[0.04]">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/[0.05] border border-white/10 mb-5">
                      <svg className="h-6 w-6 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-semibold tracking-tight text-foreground mb-3">Our Vision</h3>
                ...
                <div className="group relative overflow-hidden rounded-[24px] bg-white/[0.02] border border-white/20 p-8 sm:p-10 transition-colors hover:border-[#12ced6]/50 hover:bg-white/[0.04]">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <h3 className="text-xl font-semibold tracking-tight text-foreground mb-3">Our Mission</h3>
                    <p className="text-sm leading-relaxed text-muted/90">
              ...
              {/* Right Column: Image */}
              <div className="lg:col-span-6 lg:order-2 h-full min-h-[400px] lg:min-h-[500px]">
                <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] h-full min-h-[400px] lg:min-h-[500px]">
                  <img
